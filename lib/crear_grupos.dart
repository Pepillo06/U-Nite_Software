...
class _CrearGrupoPageState extends State<CrearGrupoPage>
  ...
  Future<void> _crearGrupo() async {
    if (_formKey.currentState!.validate()) {
      ...
      showDialog(
        ...
        builder: (context) => const Center(child: CircularProgressIndicator(color: _coloresPrimario)),
      );
      ...
      try {
        ...
        if (userId == null) throw Exception('Debes iniciar sesión para crear un grupo.');
        ...
        if (_imagenBytes != null) {
          ...
          await supabase.storage.from('fotos-grupos').uploadBinary(fileName, _imagenBytes!);
          fotoUrl = supabase.storage.from('fotos-grupos').getPublicUrl(fileName);
        }
  ...
  InputDecoration _dec(String label,
      ...
      InputDecoration(
        ...
        hintText: hint,
        labelStyle:
            GoogleFonts.lexend(fontSize: 13, color: _colorSubtexto),
        hintStyle:
            GoogleFonts.lexend(fontSize: 13, color: const Color(0xFFBBB5AF)),
        ...
        focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(12),
            borderSide:
                const BorderSide(color: _coloresPrimario, width: 1.8)),
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    // ── INFORMACIÓN BÁSICA ──────────────────────────────────
                    _SectionTitle(
                        icon: Icons.info_outline, label: 'Información básica'),
                      ...
                      child: Column(
                        ...
                        // Foto circular centrada
                          ...
                          TextFormField(
                            ...
                            style: GoogleFonts.lexend(
                                fontSize: 14, color: _colorTexto),
                            decoration: _dec('Nombre del grupo',
  ...
  Widget _materiaField() => TextFormField(
        ...
        decoration: _dec('Materia',
            hint: 'Ej: Matemáticas II', icon: Icons.book_outlined),
      );
  ...
  Widget _seccionField() => TextFormField(
        ...
        decoration: _dec('Sección',
            hint: 'Ej: 02', icon: Icons.bookmark_outline)
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        widget.imagenBytes != null
                            ? Image.memory(widget.imagenBytes!,
                                fit: BoxFit.cover)
...
class _PrivacidadToggle extends StatelessWidget {
  ...
  const _PrivacidadToggle(
      {required this.esPrivado, required this.onChanged});
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(esPrivado ? 'Grupo privado' : 'Grupo público',
                      style: GoogleFonts.lexend(
                          fontSize: 14,
                          fontWeight: FontWeight.w600,
...
class _BtnCancelar extends StatelessWidget {
  ...
  Widget build(BuildContext context) => SizedBox(
        ...
        child: OutlinedButton(
          ...
          child: Text('Cancelar',
              style: GoogleFonts.lexend(
                  color: const Color.fromARGB(255, 97, 97, 97), fontSize: 14)),
        ),
      );
}